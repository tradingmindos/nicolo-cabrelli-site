...
// Kept as a placeholder until the real number is provided.
export const WHATSAPP_NUMBER = '393282870357';
export const WHATSAPP_TEXT =
  "Ciao Nico! Ho un'attività a ___ e vorrei un preventivo per un sito web. Ti racconto cosa mi serve:";
